...
class _$ProductResponseImpl implements _ProductResponse {
  ...
  @override
  String toString() {
    return 'ProductResponse(products: $products, total: $total)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_products), total);
...
abstract class _ProductResponse implements ProductResponse {
  factory _ProductResponse(
      ...
      required final int total}) = _$ProductResponseImpl;
